...
export const CONFIG = {
  ...
  A2A_PUBLIC_URL: process.env.A2A_PUBLIC_URL,
  A2A_AGENT_NAME: process.env.A2A_AGENT_NAME,
  A2A_ORG_NAME: process.env.A2A_ORG_NAME,
  A2A_AGENT_VERSION: process.env.A2A_AGENT_VERSION,
